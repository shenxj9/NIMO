...
def _get_parser():
    ...
    # If '-train_data' is sourced from all data, '-valid_data' can be ignored.
    parser.add_argument("-train_data", "--train_data", required=True)
    parser.add_argument('-src_vocab', '--src_vocab', required=True)
    parser.add_argument("-valid_data", "--valid_data", default=None)
