...
def _get_parser():
    ...
    parser.add_argument("-train_data", "--train_data", required=True,help='Path to save an c-Transformer checkpoint.')
    parser.add_argument('-valid_data', '--valid_data', )
    parser.add_argument('-src_vocab', '--src_vocab', required=True, action='store',
                        help='Path to save an c-Transformer checkpoint.')
    parser.add_argument('-save_model', '--save_model', action='store',
                        help='Path to save an c-Transformer checkpoint.')
    parser.add_argument('-train_steps', '--train_steps',  action='store', type=int, default= 50000,
                        help='Path to save an c-Transformer checkpoint.')
    parser.add_argument('-valid_steps', '--valid_steps',  action='store', type=int, default= 2500,
                        help='Path to save an c-Transformer checkpoint.')
    parser.add_argument('-report_every', '--report_every', action='store', type=int, default= 250,
                        help='Path to save an c-Transformer checkpoint.')
    parser.add_argument('-tensorboard_log_dir', '--tensorboard_log_dir', required=True, action='store',
                        help='Path to save an c-Transformer checkpoint.')
