...
class Trainer(object):
    ...
    def train(self,
        ...
        for i, (batches, normalization) in enumerate(  #onmt/inputters/corpus.py/maybe_example1:2048个example
        ...
        # if self.model_saver is not None:
        #     self.model_saver.save(epoch, moving_average=self.moving_average)
